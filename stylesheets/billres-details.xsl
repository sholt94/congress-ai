...
<!--  VERSION:   4.5                                              -->
<!--  DATE:      July 28, 2023                                     -->
<!--  Previous version and date: Novemeber 15, 2022                 -->
<!-- ============================================================= -->
...
P.lbexBreakHere {page-break-before: always}
	...
	<xsl:template name="CongressText">
		...
		<xsl:variable name="theSrcImeage">
			<xsl:choose>
				...
				<xsl:when
					test="contains($CNum, '118') or contains(normalize-space(translate($CNum, $upper, $lower)), 'one hundred eighteenth')">
					<xsl:text>EnrolledTitle_118.JPG</xsl:text>
				</xsl:when>
				<xsl:when
					test="contains($CNum, '119') or contains(normalize-space(translate($CNum, $upper, $lower)), 'one hundred nineteenth')">
					<xsl:text>EnrolledTitle_119.JPG</xsl:text>
				</xsl:when>
				<xsl:when
					test="contains($CNum, '120') or contains(normalize-space(translate($CNum, $upper, $lower)), 'one hundred twentieth')">
					<xsl:text>EnrolledTitle_120.JPG</xsl:text>
				</xsl:when>
				<xsl:otherwise>
	...
	<xsl:template name="actualPrintCongressName">
		...
		<xsl:choose>
			...
			<xsl:when test="contains($CNum, '118')">
				<div style="text-align:center">One Hundred Eighteenth Congress <BR/> of the <BR/>
					United States of America</div>
			</xsl:when>
			<xsl:when test="contains($CNum, '119')">
				<div style="text-align:center">One Hundred Nineteenth Congress <BR/> of the <BR/>
					United States of America</div>
			</xsl:when>
			<xsl:when test="contains($CNum, '120')">
				<div style="text-align:center">One Hundred Twentieth Congress <BR/> of the <BR/>
					United States of America</div>
			</xsl:when>
			<xsl:otherwise>
	...
	<xsl:template name="actualPrintCongressNameShort">
		...
		<xsl:choose>
			...
			<xsl:when test="contains($CNum, '118')">
				<div style="text-align:center">One Hundred Eighteenth Congress</div>
			</xsl:when>
			<xsl:when test="contains($CNum, '119')">
				<div style="text-align:center">One Hundred Nineteenth Congress</div>
			</xsl:when>
			<xsl:when test="contains($CNum, '120')">
				<div style="text-align:center">One Hundred Twentieth Congress</div>
			</xsl:when>
			<xsl:otherwise>
				<xsl:if test="contains($CNum, 'of the')">
					<div style="text-align:center">
	...
	<xsl:template name="PrintImageByName">
		...
		<xsl:choose>
			...
			<xsl:when test="$imageName = 'EnrolledTitle_118.JPG'">
				<div style="text-align:center">
					<img src="EnrolledTitle_118.JPG" alt=""/>
				</div>
			</xsl:when>
			<xsl:when test="$imageName = 'EnrolledTitle_119.JPG'">
				<div style="text-align:center">
					<img src="EnrolledTitle_119.JPG" alt=""/>
				</div>
			</xsl:when>
			<xsl:when test="$imageName = 'EnrolledTitle_120.JPG'">
				<div style="text-align:center">
					<img src="EnrolledTitle_120.JPG" alt=""/>
				</div>
			</xsl:when>
		</xsl:choose>
	</xsl:template>
	...
	<xsl:template name="getCurrentElementStyle">
		<xsl:choose>
			...
			<xsl:when test="not(ancestor-or-self::title[1]/@style) and ancestor-or-self::division[1]/@style">
				<xsl:choose>
	...
	<xsl:variable name="partNum">
		<xsl:choose>
			<xsl:when test="//report-num/@part='I'">
				<xsl:text>1</xsl:text>
			</xsl:when>
			<xsl:when test="//report-num/@part='II'">
				<xsl:text>2</xsl:text>
			</xsl:when>
			<xsl:when test="//report-num/@part='III'">
				<xsl:text>3</xsl:text>
			</xsl:when>
			<xsl:when test="//report-num/@part='IV'">
				<xsl:text>4</xsl:text>
			</xsl:when>
			<xsl:when test="//report-num/@part='V'">
				<xsl:text>5</xsl:text>
			</xsl:when>
			<xsl:when test="//report-num/@part='VI'">
				<xsl:text>6</xsl:text>
			</xsl:when>
			<xsl:when test="//report-num/@part='VII'">
				<xsl:text>7</xsl:text>
			</xsl:when>
			<xsl:when test="//report-num/@part='VIII'">
				<xsl:text>8</xsl:text>
			</xsl:when>
			<xsl:when test="//report-num/@part='IX'">
				<xsl:text>9</xsl:text>
			</xsl:when>
			<xsl:when test="//report-num/@part='X'">
				<xsl:text>10</xsl:text>
			</xsl:when>
